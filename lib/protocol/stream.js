...
class Readable {
	...
	uint64() { return new Long(this.int32(), this.int32(), true) }
	...
	int64() { return new Long(this.int32(), this.int32(), false) }

	vec3() { return new Vec3(this.float(), this.float(), this.float()) }

	vec3fa() { return new Vec3(this.float() * MULT_INT16_TO_RAD, this.float() * MULT_INT16_TO_RAD, this.float() * MULT_INT16_TO_RAD) }

	angle() { return this.int16() * MULT_INT16_TO_RAD }
